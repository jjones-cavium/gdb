...
static int
delegate_insert_mc_hw_breakpoint (struct target_ops *self, struct gdbarch *arg1, struct bp_target_info *arg2, int arg3)
{
  self = self->beneath;
  return self->to_insert_mc_hw_breakpoint (self, arg1, arg2, arg3);
}

static int
tdefault_insert_mc_hw_breakpoint (struct target_ops *self, struct gdbarch *arg1, struct bp_target_info *arg2, int arg3)
{
  return -1;
}

static int
debug_insert_mc_hw_breakpoint (struct target_ops *self, struct gdbarch *arg1, struct bp_target_info *arg2, int arg3)
{
  int result;
  fprintf_unfiltered (gdb_stdlog, "-> %s->to_insert_mc_hw_breakpoint (...)\n", debug_target.to_shortname);
  result = debug_target.to_insert_mc_hw_breakpoint (&debug_target, arg1, arg2, arg3);
  fprintf_unfiltered (gdb_stdlog, "<- %s->to_insert_mc_hw_breakpoint (", debug_target.to_shortname);
  target_debug_print_struct_target_ops_p (&debug_target);
  fputs_unfiltered (", ", gdb_stdlog);
  target_debug_print_struct_gdbarch_p (arg1);
  fputs_unfiltered (", ", gdb_stdlog);
...
static int
delegate_remove_mc_hw_breakpoint (struct target_ops *self, struct gdbarch *arg1, struct bp_target_info *arg2, int arg3)
{
  self = self->beneath;
  return self->to_remove_mc_hw_breakpoint (self, arg1, arg2, arg3);
}

static int
tdefault_remove_mc_hw_breakpoint (struct target_ops *self, struct gdbarch *arg1, struct bp_target_info *arg2, int arg3)
{
  return -1;
}

static int
debug_remove_mc_hw_breakpoint (struct target_ops *self, struct gdbarch *arg1, struct bp_target_info *arg2, int arg3)
{
  int result;
  fprintf_unfiltered (gdb_stdlog, "-> %s->to_remove_mc_hw_breakpoint (...)\n", debug_target.to_shortname);
  result = debug_target.to_remove_mc_hw_breakpoint (&debug_target, arg1, arg2, arg3);
  fprintf_unfiltered (gdb_stdlog, "<- %s->to_remove_mc_hw_breakpoint (", debug_target.to_shortname);
  target_debug_print_struct_target_ops_p (&debug_target);
  fputs_unfiltered (", ", gdb_stdlog);
  target_debug_print_struct_gdbarch_p (arg1);
  fputs_unfiltered (", ", gdb_stdlog);
...
static int
delegate_multicore_hw_breakpoint (struct target_ops *self)
{
  self = self->beneath;
  return self->to_multicore_hw_breakpoint (self);
}

static int
tdefault_multicore_hw_breakpoint (struct target_ops *self)
{
  return -1;
}

static int
debug_multicore_hw_breakpoint (struct target_ops *self)
{
  int result;
  fprintf_unfiltered (gdb_stdlog, "-> %s->to_multicore_hw_breakpoint (...)\n", debug_target.to_shortname);
  result = debug_target.to_multicore_hw_breakpoint (&debug_target);
  fprintf_unfiltered (gdb_stdlog, "<- %s->to_multicore_hw_breakpoint (", debug_target.to_shortname);
  target_debug_print_struct_target_ops_p (&debug_target);
  fputs_unfiltered (") = ", gdb_stdlog);
  target_debug_print_int (result);
  fputs_unfiltered ("\n", gdb_stdlog);
...
static int
delegate_multicore_hw_watchpoint (struct target_ops *self)
{
  self = self->beneath;
  return self->to_multicore_hw_watchpoint (self);
}

static int
tdefault_multicore_hw_watchpoint (struct target_ops *self)
{
  return -1;
}

static int
debug_multicore_hw_watchpoint (struct target_ops *self)
{
  int result;
  fprintf_unfiltered (gdb_stdlog, "-> %s->to_multicore_hw_watchpoint (...)\n", debug_target.to_shortname);
  result = debug_target.to_multicore_hw_watchpoint (&debug_target);
  fprintf_unfiltered (gdb_stdlog, "<- %s->to_multicore_hw_watchpoint (", debug_target.to_shortname);
  target_debug_print_struct_target_ops_p (&debug_target);
  fputs_unfiltered (") = ", gdb_stdlog);
  target_debug_print_int (result);
  fputs_unfiltered ("\n", gdb_stdlog);
...
static int
delegate_get_core_number (struct target_ops *self)
{
  self = self->beneath;
  return self->to_get_core_number (self);
}

static int
tdefault_get_core_number (struct target_ops *self)
{
  return -1;
}

static int
debug_get_core_number (struct target_ops *self)
{
  int result;
  fprintf_unfiltered (gdb_stdlog, "-> %s->to_get_core_number (...)\n", debug_target.to_shortname);
  result = debug_target.to_get_core_number (&debug_target);
  fprintf_unfiltered (gdb_stdlog, "<- %s->to_get_core_number (", debug_target.to_shortname);
  target_debug_print_struct_target_ops_p (&debug_target);
  fputs_unfiltered (") = ", gdb_stdlog);
  target_debug_print_int (result);
  fputs_unfiltered ("\n", gdb_stdlog);
...
static void
delegate_set_core_number (struct target_ops *self, int arg1)
{
  self = self->beneath;
  self->to_set_core_number (self, arg1);
}

static void
tdefault_set_core_number (struct target_ops *self, int arg1)
{
}

static void
debug_set_core_number (struct target_ops *self, int arg1)
{
  fprintf_unfiltered (gdb_stdlog, "-> %s->to_set_core_number (...)\n", debug_target.to_shortname);
  debug_target.to_set_core_number (&debug_target, arg1);
  fprintf_unfiltered (gdb_stdlog, "<- %s->to_set_core_number (", debug_target.to_shortname);
  target_debug_print_struct_target_ops_p (&debug_target);
  fputs_unfiltered (", ", gdb_stdlog);
  target_debug_print_int (arg1);
  fputs_unfiltered (")\n", gdb_stdlog);
...
static int
delegate_remove_mc_watchpoint (struct target_ops *self, CORE_ADDR arg1, int arg2, int arg3, struct expression *arg4, int arg5)
{
  self = self->beneath;
  return self->to_remove_mc_watchpoint (self, arg1, arg2, arg3, arg4, arg5);
}

static int
tdefault_remove_mc_watchpoint (struct target_ops *self, CORE_ADDR arg1, int arg2, int arg3, struct expression *arg4, int arg5)
{
  return -1;
}

static int
debug_remove_mc_watchpoint (struct target_ops *self, CORE_ADDR arg1, int arg2, int arg3, struct expression *arg4, int arg5)
{
  int result;
  fprintf_unfiltered (gdb_stdlog, "-> %s->to_remove_mc_watchpoint (...)\n", debug_target.to_shortname);
  result = debug_target.to_remove_mc_watchpoint (&debug_target, arg1, arg2, arg3, arg4, arg5);
  fprintf_unfiltered (gdb_stdlog, "<- %s->to_remove_mc_watchpoint (", debug_target.to_shortname);
  target_debug_print_struct_target_ops_p (&debug_target);
  fputs_unfiltered (", ", gdb_stdlog);
  target_debug_print_CORE_ADDR (arg1);
  fputs_unfiltered (", ", gdb_stdlog);
...
install_delegators (struct target_ops *ops)
{
  ...
  if (ops->to_insert_mc_hw_breakpoint == NULL)
    ops->to_insert_mc_hw_breakpoint = delegate_insert_mc_hw_breakpoint;
  if (ops->to_remove_mc_hw_breakpoint == NULL)
    ops->to_remove_mc_hw_breakpoint = delegate_remove_mc_hw_breakpoint;
  if (ops->to_multicore_hw_breakpoint == NULL)
    ops->to_multicore_hw_breakpoint = delegate_multicore_hw_breakpoint;
  if (ops->to_multicore_hw_watchpoint == NULL)
    ops->to_multicore_hw_watchpoint = delegate_multicore_hw_watchpoint;
  if (ops->to_get_core_number == NULL)
    ops->to_get_core_number = delegate_get_core_number;
  if (ops->to_set_core_number == NULL)
    ops->to_set_core_number = delegate_set_core_number;
  ...
  if (ops->to_remove_mc_watchpoint == NULL)
    ops->to_remove_mc_watchpoint = delegate_remove_mc_watchpoint;
...
install_dummy_methods (struct target_ops *ops)
{
  ...
  ops->to_insert_mc_hw_breakpoint = tdefault_insert_mc_hw_breakpoint;
  ops->to_remove_mc_hw_breakpoint = tdefault_remove_mc_hw_breakpoint;
  ops->to_multicore_hw_breakpoint = tdefault_multicore_hw_breakpoint;
  ops->to_multicore_hw_watchpoint = tdefault_multicore_hw_watchpoint;
  ops->to_get_core_number = tdefault_get_core_number;
  ops->to_set_core_number = tdefault_set_core_number;
  ...
  ops->to_remove_mc_watchpoint = tdefault_remove_mc_watchpoint;
...
init_debug_target (struct target_ops *ops)
{
  ...
  ops->to_insert_mc_hw_breakpoint = debug_insert_mc_hw_breakpoint;
  ops->to_remove_mc_hw_breakpoint = debug_remove_mc_hw_breakpoint;
  ops->to_multicore_hw_breakpoint = debug_multicore_hw_breakpoint;
  ops->to_multicore_hw_watchpoint = debug_multicore_hw_watchpoint;
  ops->to_get_core_number = debug_get_core_number;
  ops->to_set_core_number = debug_set_core_number;
  ...
  ops->to_remove_mc_watchpoint = debug_remove_mc_watchpoint;
